...
function (_super) {
  ...
  Graph.prototype.removeItem = function (item, stack) {
    ...
    if (!nodeItem && (0, _util.isString)(item)) {
      ...
      if (stack && this.get('enabledStack')) {
        this.pushStack('delete', (0, _tslib.__assign)((0, _tslib.__assign)({}, nodeItem.getModel()), {
          type: type
        }));
      }
  ...
  Graph.prototype.addItem = function (type, model, stack) {
    ...
    if (stack && this.get('enabledStack')) {
      this.pushStack('add', (0, _tslib.__assign)((0, _tslib.__assign)({}, item.getModel()), {
        type: type
      }));
    }
  ...
  Graph.prototype.createCombo = function (combo, children) {
    ...
    var comboModel = currentCombo.getModel();
    trees.forEach(function (child) {
      var item = _this.findById(child.id); // step 2: 将元素添加到 Combo 中


      currentCombo.addChild(item);
      child.depth = comboModel.depth + 2;
  ...
  Graph.prototype.pushStack = function (action, data, stackType) {
    ...
    var stackData = data ? (0, _util.clone)(data) : (0, _util.clone)(this.save());
  ...
  Graph.prototype.destroy = function () {
    ...
    var tooltipContainers = document.getElementsByClassName('g6-tooltip');

    if (tooltipContainers) {
      for (var i = 0; i < tooltipContainers.length; i++) {
        var container = tooltipContainers[i];
